...
if (!$option) throw new Error('Please select a search option');

async function fetchBooksByTitle(title: Data): Promise<string> {
  try {
...
async function fetchBooksByAuthor(author: Data): Promise<string[]> {
  try {
